    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_DENTISTA = table.Column<long>(type: "NUMBER(19)", nullable: false, defaultValueSql: "SEQ_DENTISTA.NEXTVAL"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_PACIENTE = table.Column<long>(type: "NUMBER(19)", nullable: false, defaultValueSql: "SEQ_PACIENTE.NEXTVAL"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_CONSULTA = table.Column<long>(type: "NUMBER(19)", nullable: false, defaultValueSql: "SEQ_DENTISTA.NEXTVAL"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_HISTORICO = table.Column<long>(type: "NUMBER(19)", nullable: false, defaultValueSql: "SEQ_HISTORICO.NEXTVAL"),
